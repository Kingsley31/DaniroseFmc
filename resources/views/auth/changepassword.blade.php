        ...
        <div class="pt-5 pb-5 pr-3 pl-3 body-bg">
            <div class="row justify-content-center">
                <div class="col-sm-12 col-md-4">
                    @if(!session('status'))
                        @include('includes.changepasswordform')
                    @elseif(session('status'))
                        <div class="card pt-5 pb-5">
                            <img src="{{asset('images/success_icon.png')}}" class="rounded-circle success-icon mr-auto ml-auto" alt="success icon">
                            <p class="text-success text-center mt-3 pr-3 pl-3">Password change successfully!! Please <a href="/login" class="text-success">login</a> to your account to track your appoinments</p>
                        </div>
                    @endif
